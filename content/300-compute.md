...
`https://api.cloud.ca/v1/services/`[`:service_code`](#service-connections)`/`[`:environment_name`](#environments)`/:entity_type`
...
<code>https://api.cloud.ca/v1/services/<a href="#service-connections">:service_code</a>/<a href="#environments">:environment_name</a>/:entity_type/:entity_id?operation=:operation&<strong>org_id=:org_id</strong></code>
